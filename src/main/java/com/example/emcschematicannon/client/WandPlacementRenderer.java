...
public class WandPlacementRenderer {
    ...
    public static void onMouseScroll(InputEvent.MouseScrollingEvent event) {
        ...
        if (newDist != current) {
            ...
            mc.player.displayClientMessage(
                    Component.translatable("message.emcschematicannon.wand_distance", newDist)
    ...
    public static void onMouseButton(InputEvent.MouseButton.Pre event) {
        ...
        if (current != AirPlacementWandItem.DEFAULT_DISTANCE) {
            ...
            mc.player.displayClientMessage(
                    Component.translatable("message.emcschematicannon.wand_distance_reset", AirPlacementWandItem.DEFAULT_DISTANCE)
                            .withStyle(ChatFormatting.GOLD), true);
        }
        event.setCanceled(true);
    }
