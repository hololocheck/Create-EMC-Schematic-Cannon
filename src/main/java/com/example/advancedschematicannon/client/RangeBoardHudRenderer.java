...
public class RangeBoardHudRenderer {
    ...
    private static final ResourceLocation PANEL_BG =
            ResourceLocation.fromNamespaceAndPath(AdvancedSchematicCannon.MOD_ID, "textures/gui/range_board_panel.png");
    private static final ResourceLocation[] MODE_ICONS = {
            ResourceLocation.fromNamespaceAndPath(AdvancedSchematicCannon.MOD_ID, "textures/gui/range_mode_normal.png"),
            ResourceLocation.fromNamespaceAndPath(AdvancedSchematicCannon.MOD_ID, "textures/gui/range_mode_edit.png"),
    };
