...
public class InformationTabWidget extends AbstractWidget {
    private static final ResourceLocation TAB_ICON = ResourceLocation.fromNamespaceAndPath(
            AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/tab_info.png");
    private static final ResourceLocation TAB_EXPANDED = ResourceLocation.fromNamespaceAndPath(
            AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/tab_info_expanded.png");
    ...
    public InformationTabWidget(int guiLeft, int tabY) {
        super(guiLeft - TAB_SIZE, tabY, TAB_SIZE, TAB_SIZE,
                Component.translatable("gui.advancedschematicannon.information"));
        ...
        String[] keys = {
            "gui.advancedschematicannon.info.line1",
            "gui.advancedschematicannon.info.line2",
            "gui.advancedschematicannon.info.line3",
            "gui.advancedschematicannon.info.line4",
            "gui.advancedschematicannon.info.line5"
        };
