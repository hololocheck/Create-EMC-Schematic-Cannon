...
public class SettingsTabWidget extends AbstractWidget {
    private static final ResourceLocation TAB_ICON = ResourceLocation.fromNamespaceAndPath(
            AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/tab_settings.png");
    private static final ResourceLocation TAB_EXPANDED = ResourceLocation.fromNamespaceAndPath(
            AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/tab_settings_expanded.png");
    ...
    private static final String[] SCHEMATIC_TOOLTIP_KEYS = {
        "gui.advancedschematicannon.settings.dont_replace",
        "gui.advancedschematicannon.settings.replace_solid",
        "gui.advancedschematicannon.settings.replace_any",
        "gui.advancedschematicannon.settings.replace_empty",
        "gui.advancedschematicannon.settings.skip_missing",
        "gui.advancedschematicannon.settings.protect_be"
    };
    ...
    private static final String[] FILLER_TOOLTIP_KEYS = {
        "gui.advancedschematicannon.filler.fill",
        "gui.advancedschematicannon.filler.erase",
        "gui.advancedschematicannon.filler.remove",
        "gui.advancedschematicannon.filler.wall",
        "gui.advancedschematicannon.filler.tower",
        "gui.advancedschematicannon.filler.box",
        "gui.advancedschematicannon.filler.circle_wall"
    };
    // フィラーモード: 1段目4列、2段目3列
    ...
    public SettingsTabWidget(int guiRight, int tabY,
        ...
        super(guiRight, tabY, TAB_SIZE, TAB_SIZE,
                Component.translatable("gui.advancedschematicannon.settings"));
        ...
        for (int i = 0; i < SCHEMATIC_BTN_COUNT; i++) {
            schematicNormalTex[i] = ResourceLocation.fromNamespaceAndPath(
                    AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/" + SCHEMATIC_BTN_NORMAL[i]);
            schematicHoverTex[i] = ResourceLocation.fromNamespaceAndPath(
                    AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/" + SCHEMATIC_BTN_HOVER[i]);
        }
        for (int i = 0; i < FILLER_BTN_COUNT; i++) {
            fillerNormalTex[i] = ResourceLocation.fromNamespaceAndPath(
                    AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/" + FILLER_BTN_NORMAL[i]);
            fillerHoverTex[i] = ResourceLocation.fromNamespaceAndPath(
                    AdvancedSchematicCannon.MOD_ID, "textures/gui/gen2/" + FILLER_BTN_HOVER[i]);
        }
    }
